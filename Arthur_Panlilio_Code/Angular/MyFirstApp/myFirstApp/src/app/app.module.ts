...
import { SquarerootpipePipe } from './pipes/squarerootpipe.pipe';
...
@NgModule({
  declarations: [
    ...
    classes listed here: components, directive, and pipes.
    */
    AppComponent,
    HomeComponent,
    NavbarComponent,
  ...
  /*
  ,exports:[]
  classes that need to be accessable to classes
  ...
  */
  imports: [
    /*
    modules whose classes are needed within 
    this current module
    */
    BrowserModule,
    FormsModule,
