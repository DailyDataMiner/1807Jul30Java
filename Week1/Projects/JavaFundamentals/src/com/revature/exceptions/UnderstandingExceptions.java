...
public class UnderstandingExceptions {
	...
	static void doThings(String[] args) {
		...
		/*
		 * catch(IOException e) { System.out.println("Caught IOE");
	...
	static void exploreStack(String[] args) throws IOException { // goes after method signature; indicates that this
																	// method will throw this exception and calling
