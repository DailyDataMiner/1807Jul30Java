...
public class ConnectionFactory {
	 ...
	 * Uses singleton design pattern to return same 
	 * single connection each time one is requested.
	 * to establish connection, we need 4 things
	 * driver, URL(location of DB), username, PW
	 * 
	 */
	...
	public Connection getConnection() {
		...
		String path = "C:/Users/Joel DeVos/my_git_repo/1807Jul30Java/bankapp-test-w-war/src/main/resources/application.properties";
		try {
