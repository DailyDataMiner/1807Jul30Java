...
@NgModule({
  declarations: [
    ...
    componets, directives, and pipes
    */
    AppComponent,
    HomeComponent,
    NavbarComponent,
  ...
  exports:[],
  /*
  classes that need to be accessible to the components of other modules.
  However, we're not making multi-modular apps at the moment, so we do not need anything in the exports array
  */
  imports: [
    /*
