...
public class ConnectionFactory {
	...
	/*
	 * Connection
	 *  - manages pour connection to (session with) the database
	...
	public Connection getConnection() {
		...
		String path = "C:/Users/Ryan/my_git_repos/1807Jul30Java/Ryan_Posey_Code/Week2/jdbc/bookstore-jdbc/src/main/resources/application.properties";
		try {
