/**
 * Single JS script for entire bookstore app. Separate functionality into
 * methods and keep as organized as possible.. as this will get lengthy
 */

window.onload=function(){
	$('#homeNav').on('click', loadHomeView);
	$('#test1').on('click', loadHomeView);
