...
public class Reimbursement {
	...
	public Reimbursement(int ticket_id, String ticket_status, String created_on, String description, 
						 String reimb_type, double amount, String reimb_status,
						 String resolver,  String receipt) {
		super();
		this.ticket_id = ticket_id;
		this.ticket_status = ticket_status;
		this.created_on = created_on;
	...
	public String toString() {
		return "Reimbursement [ticket_id=" + ticket_id + ", ticket_status=" + ticket_status + ", created_on="
				+ created_on + ", description=" + description + ", amount=" + amount + ", resolver=" + resolver
				+ ", reimb_type=" + reimb_type + ", reimb_status=" + reimb_status + ", receipt=" + receipt + "]";
	}
