...
public class JDBCConnection {
	...
	private static JDBCConnection cf = null;
	...
	public static synchronized JDBCConnection getInstance() {
		if(build) cf = new JDBCConnection();
		return cf;
	}
	
	/*
	 * if there's error file not found exception
	 * then, go to application.properties  , right click --> properties --> 
	 * copy from 'location' --> paste into JDBCConnection's path , also change all '\\' into '/'
	 * 
	 * C:/Users/zyang/Documents/workspace-sts-3.9.5.RELEASE/project0_v1_getBankUser/project0/src/main/resources/application.properties
	 * Connection 
	 * 
	 * 
	 * 
	...
	public Connection getConnection() {
		...
		String path = "C:/Users/zyang/Documents/workspace-sts-3.9.5.RELEASE/project0_v1_getBankUser/project0/src/main/resources/application.properties";
		try {
